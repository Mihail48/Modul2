<?php $this->layout('layout', ['title' => 'page_profile']) ?>
                        ...
                        <div class="row no-gutters row-grid">
                            <div class="col-12">
                                <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                    ...
                                    <img src="upload/avatar-m.png" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                    <?php else:?>
                                    <img src="upload/<?=$user['img'];?>" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                    <?php endif;?>
