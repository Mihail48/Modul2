<?php $this->layout('layout', ['title' => 'page_create_user']) ?>
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="example-select">Выберите статус</label>
                                        <select name="set_status" class="form-control" id="example-select">
                                            <!-- указываем в массиве статусы и соответствие этих статусов цвету который будет отображаться на аватарке -->
                                            <?php $status = ['success'=>'Онлайн',
                                                            'danger'=>'Отошел',
                                                            'warning'=>'Не беспокоить'];?>
                                            <?php foreach ($status as $stat=>$text): ?>
                                            <option value="<?php echo $stat;?>" ><?php echo $text;?></option>
                                            <?php endforeach;?>
                                        </select>
                                </div>
