<?php $this->layout('layout', ['title' => 'users_page']) ?>
    ...
    <body class="mod-bg-1 mod-nav-link">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                ...
                <!-- выводим кнопку войти если пользователь не залогинился и выводим кнопку выйти если зологинился -->
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <!-- выводим кнопку только если пользователь админ -->
            ...
            <div class="row" id="js-contacts">
                <?php foreach ($paging as $user):?>
                <div class="col-xl-4">
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <!-- цвет статуса, поумолчанию ставим в сети -->
                                <span class="status status-<?php echo $user['status'] ?? 'success';?> mr-3">
                                    <!-- выводим аватарку и если она не установлена , то выводим поумолчанию картинку заглушку  -->
                                    <a href="/profile?id=<?php echo $user['id'];?>"><span class="rounded-circle profile-image d-block " style="background-image:url('upload/<?=$user['img'] ?? 'avatar-m.png';?>'); background-size: cover;"></a></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="profile?id=<?php echo $user['id'];?>" class="fs-xl text-truncate text-truncate-lg text-info"  aria-expanded="false">
                                         <?php echo $user['username'];?>
                                    </a>
                                    <!-- если пользователь админ или пользователь зашел под своим логином, позволяем выводить следующие ссылки -->
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="/status?id=<?php echo $user['id'];?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="/images?id=<?php echo $user['id'];?>">
            ...
            <ul class="pagination">
                <?php if ($paginator->getPrevUrl()): ?>
                    <li><a href="<?php echo $paginator->getPrevUrl(); ?>">&laquo; <b>ПРЕДЫДУЩАЯ</b></a></li>
                <?php endif; ?>
                ...
                <?php if ($paginator->getNextUrl()): ?>
                    <li><a href="<?php echo $paginator->getNextUrl(); ?>"><b>СЛЕДУЩАЯ</b> &raquo;</a></li>
                <?php endif; ?>
            </ul>
        ...
        <footer class="page-footer" role="contentinfo">
            ...
            <div>
                <ul class="list-table m-0">
                    ...
                    <li class="pl-3"><a href="profile?id=<?=$user['id']?>" class="text-secondary fw-700">About</a></li>
                </ul>
            </div>
        </footer>
